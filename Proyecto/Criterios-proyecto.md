...
## Integrantes del Grupo (Maximo 2 personas)
...
El repositorio debe incluir un archivo `README.md` o un documento que describa la estructura y funcionamiento del proyecto.  
...
- Antes de la exposición se debe compartir el proyecto en **enlace del repositorio** o **drive** al correo daniel.munoz.melendez@unillanos.edu.co
- Si es en repositorio puede ser público o privado, pero debe estar correctamente compartido con el docente.

---

## Requisitos Técnicos

- El proyecto debe **consumir al menos dos (2) servicios de las APIs brindadas**.  
...
- **Individual:** mínimo **10 minutos**
- **En pareja:** mínimo **15 minutos**
...
- Revisa la organización del proyecto compartido y evita incluir archivos innecesarios.  
...
- Se debe registrar en la siguiente planilla el nombre del o de los integrantes del equipo y el API seleccionada en https://docs.google.com/spreadsheets/d/10H5IVBlDBkFKNIHu9Bdvb-vUQ7AiCO2zb_ynPfWeEQo/edit?usp=sharing
